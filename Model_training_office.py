...
def baseline_model(inputDim=-1, out_shape=(-1,)):
    ...
    if inputDim > 0 and out_shape[1] > 0:
        # ✅ Fix: Use Input layer instead of input_shape in Dense
        model.add(Input(shape=(inputDim,)))  # Explicit input layer
        model.add(Dense(79, activation='relu'))  # No input_shape here
